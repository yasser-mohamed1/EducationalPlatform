    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionCorrectAnswers", x => new { x.QuestionId, x.CorrectAnswer });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    subjName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Quiz_Question", x => new { x.QuestionsId, x.quizzesId });
                    table.ForeignKey(
                        name: "FK_Quiz_Question_Questiones_QuestionsId",
                        column: x => x.QuestionsId,
                        principalTable: "Questiones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Quiz_Question_Quizzes_quizzesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizStudent", x => new { x.QuizsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_QuizStudent_Quizzes_QuizsId",
                        column: x => x.QuizsId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnswerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResultId = table.Column<int>(type: "int", nullable: true),
                    AnswerId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerResults", x => x.AnswerId);
                    table.ForeignKey(
                        name: "FK_AnswerResults_Answers_AnswerId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerResults_AnswerId1",
                table: "AnswerResults",
                column: "AnswerId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Quiz_Question_quizzesId",
                table: "Quiz_Question",
                column: "quizzesId");
